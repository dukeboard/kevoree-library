...
/**
 * {@link org.apache.commons.beanutils.Converter} implementaion that handles conversion to and from <b>java.lang.Number</b> objects.
 * <p>
 * This implementation handles conversion for the following <code>java.lang.Number</code> types.
 * <ul>
 ...
 * <li><code>setLocale(Locale)</code></li>
 * </ul>
 * <li>If none of the above are configured the <code>toNumber(String)</code> method is used to convert from String to Number and the Number's
 * <code>toString()</code> method used to convert from Number to String.</li> </ul>
 * 
 * <p>
 * <strong>N.B.</strong>Patterns can only be specified used the <i>standard</i> pattern characters and NOT in <i>localized</i> form (see
 * <code>java.text.SimpleDateFormat</code>). For example to cater for number styles used in Germany such as <code>0.000,00</code> the pattern is
 * specified in the normal form <code>0,000.00</code> and the locale set to <code>Locale.GERMANY</code>.
 * 
...
public abstract class NumberConverter extends AbstractConverter {
    ...
    /**
     * Construct a <b>java.lang.Number</b> <i>Converter</i> that throws a <code>ConversionException</code> if a error occurs.
     * 
     * @param allowDecimals
     ...
     *            <code>true</code> if a number format should be used.
     */
    ...
    /**
     * Return the number format pattern used to convert Numbers to/from a <code>java.lang.String</code> (or <code>null</code> if none specified).
     * <p>
     * See <code>java.text.SimpleDateFormat</code> for details of how to specify the pattern.
     * 
    ...
    /**
     * Set a number format pattern to use to convert Numbers to/from a <code>java.lang.String</code>.
     * <p>
     * See <code>java.text.SimpleDateFormat</code> for details of how to specify the pattern.
     * 
     * @param pattern
