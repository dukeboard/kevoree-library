 ...
 * 
 * <p>
 * The implementations for these methods are provided by <code>PropertyUtilsBean</code>. For more details see {@link PropertyUtilsBean}.
 * </p>
 * 
...
public class PropertyUtils {
     ...
     * 
     * @deprecated The notation used for property name expressions is now dependant on the {@link org.apache.commons.beanutils.expression.Resolver}
     ...
     * 
     * Note that this static variable will have unexpected side-effects if this class is deployed in a shared classloader within a container. However
     * as it is actually completely ignored by this class due to its deprecated status, it doesn't do any actual harm.
     * 
     ...
     * actual getter and setter methods might have been customized via <code>BeanInfo</code> classes).
     * </p>
     * 
     * <p>
     * For more details see <code>PropertyUtilsBean</code>.
