 ...
 * 
 * <p>
 * This class provides implementations for the utility methods in {@link BeanUtils}. Different instances can be used to isolate caches between
...
public class BeanUtilsBean {
     ...
     *            use this <code>ConvertUtilsBean</code> to perform conversions from one object to another
     * 
     * @since 1.8.0
     */
     ...
     *            use this <code>PropertyUtilsBean</code> to access properties
     */
     ...
     * 
     * <p>
     * <strong>Note:</strong> this method creates a <strong>shallow</strong> clone. In other words, any objects referred to by the bean are shared
     * with the clone rather than being cloned in turn.
     * </p>
     * 
     * @param bean
     *            Bean to be cloned
    ...
    /**
     * <p>
     * Copy property values from the origin bean to the destination bean for all cases where the property names are the same. For each property, a
     * conversion is attempted as necessary. All combinations of standard JavaBeans and DynaBeans as origin and destination are supported. Properties
     * that exist in the origin bean, but do not exist in the destination bean (or are read-only in the destination bean) are silently ignored.
     * </p>
     * 
     * <p>
     ...
     * pointing at the corresponding property values that will be converted (if necessary) and set in the destination bean. <strong>Note</strong> that
     * this method is intended to perform a "shallow copy" of the properties and so complex properties (for example, nested ones) will not be copied.
     * </p>
     * 
     * <p>
     * This method differs from <code>populate()</code>, which was primarily designed for populating JavaBeans from the map of request parameters
     * retrieved on an HTTP request, is that no scalar->indexed or indexed->scalar manipulations are performed. If the origin property is indexed, the
     * destination property must be also.
     * </p>
     * 
     * <p>
     * If you know that no type conversions are required, the <code>copyProperties()</code> method in {@link PropertyUtils} will execute faster than
     * this method.
     * </p>
     * 
     * <p>
     * <strong>FIXME</strong> - Indexed and mapped properties that do not have getter and setter methods for the underlying array or Map are not
     ...
     *                if the <code>dest</code> or <code>orig</code> argument is null or if the <code>dest</code> property type is different from the
    ...
    /**
     * <p>
     * Copy the specified property value to the specified destination bean, performing any type conversion that is required. If the specified bean
     * does not have a property of the specified name, or the property is read only on the destination bean, return without doing anything. If you
     * have custom destination property types, register {@link Converter}s for them by calling the <code>register()</code> method of
     * {@link ConvertUtils}.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Return the entire set of properties for which the specified bean provides a read method. This map contains the to <code>String</code> converted
     * property values for all properties for which a read method is provided (i.e. where the getReadMethod() returns non-null).
     * </p>
     * 
     * <p>
     * This map can be fed back to a call to <code>BeanUtils.populate()</code> to reconsitute the same set of properties, modulo differences for
     * read-only and write-only properties, but only if there are no indexed properties.
     * </p>
     * 
     * <p>
     * <strong>Warning:</strong> if any of the bean property implementations contain (directly or indirectly) a call to this method then a stack
     * overflow may result. For example: <code><pre>
     * class MyBean
     * {
     ...
     *    }
     * }
     * </pre></code> will result in an infinite regression when <code>getParametersMap</code> is called. It is recommended that such methods are given
     * alternative names (for example, <code>parametersMap</code>).
     * </p>
     * 
     * @param bean
    ...
    /**
     * Return the value of the specified indexed property of the specified bean, as a String. The zero-relative index of the required value must be
     * included (in square brackets) as a suffix to the property name, or <code>IllegalArgumentException</code> will be thrown.
     * 
     * @param bean
     *            Bean whose property is to be extracted
     * @param name
    ...
    /**
     * Return the value of the specified indexed property of the specified bean, as a String. The index is specified as a method parameter and must
    ...
    /**
     * Return the value of the specified indexed property of the specified bean, as a String. The String-valued key of the required value must be
     * included (in parentheses) as a suffix to the property name, or <code>IllegalArgumentException</code> will be thrown.
     * 
     * @param bean
     *            Bean whose property is to be extracted
     * @param name
    ...
    /**
     * <p>
     * Populate the JavaBeans properties of the specified bean, based on the specified name/value pairs. This method uses Java reflection APIs to
     * identify corresponding "property setter" method names, and deals with setter arguments of type <code>String</code>, <code>boolean</code>,
     * <code>int</code>, <code>long</code>, <code>float</code>, and <code>double</code>. In addition, array setters for these types (or the
     * corresponding primitive types) can also be identified.
     * </p>
     * 
     * <p>
     * The particular setter method to be called for each property is determined using the usual JavaBeans introspection mechanisms. Thus, you may
     * identify custom setter methods using a BeanInfo class that is associated with the class of the bean itself. If no such BeanInfo class is
     * available, the standard method name conversion ("set" plus the capitalized name of the property in question) is used.
     * </p>
     * 
     * <p>
     * <strong>NOTE</strong>: It is contrary to the JavaBeans Specification to have more than one setter method (with different argument signatures)
     * for the same property.
     * </p>
     * 
     * <p>
     * <strong>WARNING</strong> - The logic of this method is customized for extracting String-based request parameters from an HTTP request. It is
     * probably not what you want for general property copying with type conversion. For that purpose, check out the <code>copyProperties()</code>
     * method instead.
     * </p>
     * 
     * @param bean
     ...
     * 
     * <p>
     * If <code>null</code> is passed into a property expecting a primitive value, then this will be converted as if it were a <code>null</code>
     * string.
     * </p>
     * 
     * <p>
     * <strong>WARNING</strong> - The logic of this method is customized to meet the needs of <code>populate()</code>, and is probably not what you
     * want for general property copying with type conversion. For that purpose, check out the <code>copyProperty()</code> method instead.
     * </p>
     * 
     * <p>
     * <strong>WARNING</strong> - PLEASE do not modify the behavior of this method without consulting with the Struts developer community. There are
     * some subtleties to its functionality that are not documented in the Javadoc description above, yet are vital to the way that Struts utilizes
     * this method.
     * </p>
     * 
     * @param bean
     ...
     * 
     * @return A <code>Method<code> for <code>Throwable.initCause</code>, or <code>null</code> if unavailable.
     */
