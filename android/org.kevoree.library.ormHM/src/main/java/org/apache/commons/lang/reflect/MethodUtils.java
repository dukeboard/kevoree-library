...
/**
 * <p>
 * Utility reflection methods focused on methods, originally from Commons BeanUtils. Differences from the BeanUtils version may be noted, especially
 ...
 * <p>
 * There is an issue when invoking public methods contained in a default access superclass on JREs prior to 1.4. Reflection locates these methods fine
 * and correctly assigns them as public. However, an <code>IllegalAccessException</code> is thrown if the method is invoked.
 * </p>
 * 
 * <p>
 ...
 * succeeds, then the method can be invoked as normal. This call will only succeed when the application has sufficient security privileges. If this
 * call fails then the method may fail.
 * </p>
 * 
...
public class MethodUtils {
    ...
    /**
     * <p>
     * MethodUtils instances should NOT be constructed in standard programming. Instead, the class should be used as
            ...
            if (method.getName().equals(methodName)) {
                ...
                if (ClassUtils.isAssignable(parameterTypes, method.getParameterTypes(), true)) {
                    ...
                    if (accessibleMethod != null) {
                        if (bestMatch == null
                                || MemberUtils.compareParameterTypes(accessibleMethod.getParameterTypes(), bestMatch.getParameterTypes(),
                                        parameterTypes) < 0) {
