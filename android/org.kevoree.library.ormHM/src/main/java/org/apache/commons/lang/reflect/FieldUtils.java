...
public class FieldUtils {
    ...
    /**
     * Gets an accessible <code>Field</code> by name repecting scope. Superclasses/interfaces will be considered.
     * 
     * @param cls
     ...
     *            the field name to obtain
     * @param forceAccess
     *            whether to break scope restrictions using the <code>setAccessible</code> method. <code>False</code> will only match public fields.
     * @return the Field object
     * @throws IllegalArgumentException
     *             if the class or field name is null
     */
    public static Field getField(final Class<?> cls, String fieldName, boolean forceAccess) {
        ...
        // superclass field.
        Field match = null;
        for (Object element : ClassUtils.getAllInterfaces(cls)) {
            try {
                Field test = ((Class<?>) element).getField(fieldName);
                if (match != null) {
    ...
    /**
     * Gets an accessible <code>Field</code> by name breaking scope if requested. Only the specified class will be considered.
     * 
     * @param cls
     *            the class to reflect, must not be null
     * @param fieldName
     *            the field name to obtain
     * @param forceAccess
     *            whether to break scope restrictions using the <code>setAccessible</code> method. False will only match public fields.
     * @return the Field object
     * @throws IllegalArgumentException
     *             if the class or field name is null
     */
