 ...
 * <p>
 * Implementations should provide conversion to the specified type and from the specified type to a <code>String</code> value by implementing the
 * following methods:
 * <ul>
 * <li><code>convertToString(value)</code> - convert to a String (default implementation uses the objects <code>toString()</code> method).</li>
...
public abstract class AbstractConverter implements Converter {
    ...
    /**
     * Construct a <i>Converter</i> that throws a <code>ConversionException</code> if an error occurs.
     */
     ...
     * 
     * @return <code>true</code> if a default value will be returned for conversion errors or <code>false</code> if a {@link ConversionException} will
     *         be thrown.
     */
     ...
     * <p>
     * <b>N.B.</b>This implementation simply uses the value's <code>toString()</code> method and should be overriden if a more sophisticated mechanism
     * for <i>conversion to a String</i> is required.
     * 
     * @param value
     *            The input value to be converted.
     ...
     * @throws ConversionException
     *             if no default value has been specified for this {@link Converter}.
     */
     ...
     * <p>
     * If the default value is different from the type the <code>Converter</code> handles, it will be converted to the handled type.
     * 
     * @param defaultValue
     *            The default value to be returned if the value to be converted is missing or an error occurs converting the value.
     * @throws ConversionException
