 ...
 * {@link Converter}.
 * <p />
 * This implementation can be used to prevent registered {@link Converter} implementations that provide configuration options from being retrieved and
 * modified.
 * 
...
public final class ConverterFacade implements Converter {
    ...
    /**
     * Construct a converter which delegates to the specified {@link Converter} implementation.
     * 
     * @param converter
