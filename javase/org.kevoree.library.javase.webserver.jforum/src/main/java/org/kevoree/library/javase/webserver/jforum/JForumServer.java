package org.kevoree.library.javase.webserver.jforum;
...
@ComponentType
public class JForumServer extends AbstractComponentType {
    ...
    public void startServer() throws ClassNotFoundException, NoSuchMethodException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        ...
        logger.info("JForum User Home at "+System.getProperty("JENKINS_HOME"));
        ...
        org.kevoree.framework.FileNIOHelper.unzipToTempDir(this.getClass().getClassLoader().getResourceAsStream("jforum-2.1.9.zip"), tempWarDir, java.util.Arrays.asList(".filtered"), java.util.Arrays.asList(".filtered"));
        args.put("webroot", tempWarDir.getAbsolutePath() + File.separator + "jforum-2.1.9");
